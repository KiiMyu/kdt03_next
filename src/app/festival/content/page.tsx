...
export default function FestivalContents() {
    ...
    const item: FestivalItem | undefined = itemString
        ? JSON.parse(decodeURIComponent(itemString))
        : undefined;
            ...
            <div className="w-9/10 h-full flex flex-col justify-center items-center overflow-y-auto">
                ...
                <div className="flex flex-col justify-center items-center p-5">
                    ...
                    <div className="flex flex-row jusfity-center p-5">
                        ...
                        <Link href={`/festival?gugun=${item?.GUGUN_NM}`} className="hover:cursor-pointer text-white bg-blue-700 font-bold px-5 py-2 m-5 rounded-2xl">
                            목록으로
                        </Link>
                    </div>
                </div>
